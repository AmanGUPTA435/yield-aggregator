...
module thala_launch::package {
    ...
    //                                                                        //
    const DEPLOYER_ADDRESS: address = @thala_launch_deployer;                 //
    const RESOURCE_ACCOUNT_SEED: vector<u8> = b"thala_launch";                //
    const RESOURCE_ACCOUNT_ADDRESS: address = @thala_launch;                  //
    //                                                                        //
    // Modules that can interface with the resource signer                    //
    friend thala_launch::lbp;                                                 //
    friend thala_launch::fees;                                                //
    //                                                                        //
    //                                                                        //
    // *************************************************************************
    ...
    fun publish_package_unauthorized_err(thala_launch: &signer) acquires ResourceSignerCapability {
        // setup the manager & package resource
        thala_manager::manager::initialize_for_test(signer::address_of(thala_launch));
        init_for_test();
