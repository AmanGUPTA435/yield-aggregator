...
module sushi::swap {
    ...
    const DEFAULT_ADMIN: address = @0x59a41b6f13680b450131cba2e1422db65ff525897c3104ac167272d462151387;
    const RESOURCE_ACCOUNT: address = @sushi;
    const DEV: address = @0x162a7823314b70050b4df595912d17f75ba0352c1f2cd12be6f2921449d0e842;
    ...
    struct TokenPairMetadata<phantom X, phantom Y> has key {
        ...
        ///#TODO:Changes for remove liquidity

        token_x_details:TokenDetails,
        token_y_details:TokenDetails,
    ...
    */
    ...
    public(friend) fun create_pair<X, Y>(
        ...
        let lp_name: string::String = string::utf8(b"Sushi-");
        ...
        if (string::length(&lp_name) > MAX_COIN_NAME_LENGTH) {
            lp_name = string::utf8(b"Sushi LPs");
        };
        ...
        let tokenX = TokenDetails{
            token_address:type_info::type_name<X>(),
            name:coin::name<X>(),
            decimals:coin::decimals<X>(),
            symbol:coin::symbol<X>()
        };
        
        let tokenY = TokenDetails{
            token_address:type_info::type_name<Y>(),
            name:coin::name<Y>(),
            decimals:coin::decimals<Y>(),
            symbol:coin::symbol<Y>()
        };
        ...
        move_to<TokenPairMetadata<X, Y>>(
            ...
            TokenPairMetadata {
                ...
                burn_cap,
                freeze_cap,
                token_x_details:tokenX,
                token_y_details:tokenY,
            }
        );
