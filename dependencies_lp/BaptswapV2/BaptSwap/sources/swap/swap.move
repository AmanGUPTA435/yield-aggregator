...
module baptswap::swap {
    ...
    const DEFAULT_ADMIN: address = @0xefb4da60354e5b2f419ee71fb277677a7c1b8cb1a3d4bbf0455d561ebf199eef;
    const RESOURCE_ACCOUNT: address = @baptswap;
    const DEV: address = @0xfc2c54cd877d119618171927f283a2dd73f4860f76ae26dec43b3d1c05106f38;
