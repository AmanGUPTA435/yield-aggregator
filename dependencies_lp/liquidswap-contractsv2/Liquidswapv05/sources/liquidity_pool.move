...
module liquidswap_v05::liquidity_pool {
    ...
    public fun register<X, Y, Curve>(acc: &signer) acquires PoolAccountCapability {
        ...
        assert!(!exists<LiquidityPool<X, Y, Curve>>(@0x61d2c22a6cb7831bee0f48363b0eec92369357aece0d1142062f7d5d85c7bef8), ERR_POOL_EXISTS_FOR_PAIR);
    ...
    acquires LiquidityPool, EventsStore {
        ...
        assert!(coin_helper::is_sorted<X, Y>(), ERR_WRONG_PAIR_ORDERING);
        assert!(exists<LiquidityPool<X, Y, Curve>>(@0x61d2c22a6cb7831bee0f48363b0eec92369357aece0d1142062f7d5d85c7bef8), ERR_POOL_DOES_NOT_EXIST);

        assert_pool_unlocked<X, Y, Curve>();

        let lp_coins_total = coin_helper::supply<LP<X, Y, Curve>>();

        let pool = borrow_global_mut<LiquidityPool<X, Y, Curve>>(@0x61d2c22a6cb7831bee0f48363b0eec92369357aece0d1142062f7d5d85c7bef8);
        ...
        let events_store = borrow_global_mut<EventsStore<X, Y, Curve>>(@0x61d2c22a6cb7831bee0f48363b0eec92369357aece0d1142062f7d5d85c7bef8);
        event::emit_event(
    ...
    fun split_fee_to_dao<X, Y, Curve>(
        ...
        dao_storage::deposit<X, Y, Curve>(@0x61d2c22a6cb7831bee0f48363b0eec92369357aece0d1142062f7d5d85c7bef8, dao_x_in, dao_y_in);
    }
    ...
    fun assert_pool_unlocked<X, Y, Curve>() acquires LiquidityPool {
        let pool = borrow_global<LiquidityPool<X, Y, Curve>>(@0x61d2c22a6cb7831bee0f48363b0eec92369357aece0d1142062f7d5d85c7bef8);
    ...
    acquires LiquidityPool {
        ...
        let liquidity_pool = borrow_global<LiquidityPool<X, Y, Curve>>(@0x61d2c22a6cb7831bee0f48363b0eec92369357aece0d1142062f7d5d85c7bef8);
    ...
    public fun is_pool_exists<X, Y, Curve>(): bool {
        assert!(coin_helper::is_sorted<X, Y>(), ERR_WRONG_PAIR_ORDERING);
        exists<LiquidityPool<X, Y, Curve>>(@0x61d2c22a6cb7831bee0f48363b0eec92369357aece0d1142062f7d5d85c7bef8)
    }
    ...
    public fun update_cumulative_price_for_test<X, Y>(
        ...
        let pool =
            borrow_global_mut<LiquidityPool<X, Y, curves::Uncorrelated>>(@0x61d2c22a6cb7831bee0f48363b0eec92369357aece0d1142062f7d5d85c7bef8);
    ...
    public fun get_reserved_value<X, Y, Curve>(): u64 acquires LiquidityPool {
        let pool =
            borrow_global<LiquidityPool<X, Y, curves::Uncorrelated>>(@0x61d2c22a6cb7831bee0f48363b0eec92369357aece0d1142062f7d5d85c7bef8);
