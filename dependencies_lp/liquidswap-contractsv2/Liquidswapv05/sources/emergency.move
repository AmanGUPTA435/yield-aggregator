...
module liquidswap_v05::emergency {
    ...
    public entry fun resume(account: &signer) acquires IsEmergency {
        ...
        let IsEmergency {} = move_from<IsEmergency>(@0x40f545e01332a00225e74a369eda3aed76a32dc6dccf6c08fba4499476d329);
    }

    /// Get if it's paused or not.
    public fun is_emergency(): bool {
        exists<IsEmergency>(@0x40f545e01332a00225e74a369eda3aed76a32dc6dccf6c08fba4499476d329)
    }
    ...
    public fun is_disabled(): bool {
        exists<IsDisabled>(@0x40f545e01332a00225e74a369eda3aed76a32dc6dccf6c08fba4499476d329)
    }
