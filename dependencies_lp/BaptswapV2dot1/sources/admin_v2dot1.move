...
module baptswap_v2dot1::admin_v2dot1 {
    ...
    fun init_module(sender: &signer) {
        ...
        move_to(&resource_signer, AdminInfo {
            signer_cap,
            treasury_address: @0x6dc7c3b14905bff00bd58cce4b140b86f2bf4814bd72e8c95caec370ed5fe41c,
            admin: @0x6dc7c3b14905bff00bd58cce4b140b86f2bf4814bd72e8c95caec370ed5fe41c,
